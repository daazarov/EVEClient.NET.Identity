namespace EVEClient.NET.Identity.Configuration
{
    public enum IdentityMode
    {
        ...
        /// If the user is not authenticated via EVEAuthenticationScheme, HttpContext.Current.Identity will return identity from default selector.
        /// </summary>
        PrimaryIdentity,
        ...
        /// HttpContext.Current.Identity will return identity from default selector excluding EVE Identity.
        /// </summary>
        /// <remarks>
