...
namespace EVEClient.NET.Identity.Extensions
{
    public static class AuthenticationPropertiesExtensions
    {
        ...
        /// <summary>
        /// Indicates whether the properties have all the necessary items for correct work.
        /// </summary>
        public static bool ValidateForEveOnline(this AuthenticationProperties properties)
        {
            ...
            return properties.GetUserSessionId().IsPresent() && 
                   properties.GetEveAccessTokenReferenceKey().IsPresent() &&
                   properties.GetEveRefreshTokenReferenceKey().IsPresent();
        }
    }
}
